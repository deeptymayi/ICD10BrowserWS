...
public interface ICDAppConstants {
	...
	public static final String PRESCRIPTION_PERSISTENCE_SUCCESS_RESPONSE_BODY = "{\"success\" : true, \"message\": \"Prescription persisted successful.\"}";
	public static final String PRESCRIPTION_PERSISTENCE_FAILURE_RESPONSE_BODY = "{\"success\" : false, \"message\" : \"The prescription could not be saved.\"}";
}
